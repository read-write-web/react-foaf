...
//						+ " as object: "+pointerExistsAsObject())
    ...
    $rdf.PointedGraph.prototype.getSymbol = function() {
        var self = this;
        var args = _.flatten(arguments); // TODO: check if this need to be flatten or not.

        // List of PGs.
        debug("getSymbol !!!")
        var pgList = this.rels.apply(this, args);
        debug(pgList)
    ...
    * */
    $rdf.PointedGraph.prototype.deepCopyOfGraph = function() {
        var self = this;
        var deepCopy = new $rdf.PointedGraph();
        deepCopy.pointer = this.pointer;
        deepCopy.webGraph = this.webGraph;
        deepCopy.internalGraph = this.internalGraph;
